...
//Step Scenario: Login Page
export class LoginPage {
  readonly page: Page;
  readonly url = 'https://gherkin-pilot-web.stagingapps.net/auth/sign_in';
  readonly loginHeader = '//h1[normalize-space()="Get Started with Gherkin Project"]';
  ...
  async visibleLoginPage() {
    await this.page.isVisible(this.loginHeader);
  }
