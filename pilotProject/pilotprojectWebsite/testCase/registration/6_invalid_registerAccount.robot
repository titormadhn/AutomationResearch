...
Resource    ../../../pilotprojectWebsite/stepDefinition/registration/sd_6_invalid_registerAccount.resource
Metadata    Feature    Web Registration
Metadata    Generated by    _gherkin2robotframework on 2025-01-31T11:58:51.330819_
...
Scenario Outline Invalid Register Account
    [Arguments]    ${nama_lengkap}    ${no_tlp}    ${email}    ${password}    ${confirm_pswd}    ${err_msg}
    ...
    And i select "Andir" from "Kecamatan" dropdown
    ...
    And i choose "OK" in pop up confirmation "${err_msg}"
